...
export declare enum OotFlagTypes {
    SCENE = 0,
    SKULLTULA = 1,
    ITEM = 2,
    INF = 3,
...
export declare enum OotFlagSubTypes {
    NONE = 0,
    CHEST = 1,
    SWITCH = 2,
    ROOM_CLEAR = 3,
...
export declare class OotFlagEventImpl implements OotFlagEvent {
    type: OotFlagTypes;
    subtype: OotFlagSubTypes;
    scene: Scene;
    flagNumber: number;
...
export declare class SceneStruct {
    buf: Buffer;
